    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Route::is('admin.permohonan') ? 'active' : '' }}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item">
                            <a href="{{ route('admin.profiles') }}"
                                class="submenu-link {{ Route::is('admin.profiles') ? 'text-primary' : '' }}">Profil</a>

                        </li>

                        <li class="submenu-item">
                            <a href="{{ route('admin.security') }}"
                                class="submenu-link {{ Route::is('admin.security') ? 'text-primary' : '' }}">Security</a>
                        </li>
                    </ul>
                </li>
            </ul>
