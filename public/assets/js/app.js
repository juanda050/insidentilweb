...
*/
          (function () {
            var u = (function () {
              ...
              function h(T, j) {
                for (var S = j.length, L = 0; L < S; ++L) v(T, j[L]);
              }
            ...
            if (
              (Lt &&
                ...
                O !== Object.prototype &&
                  ...
                  (!A &&
                    u(Ee) !== O &&
                    (p ? p(Ee, O) : typeof Ee[j] != "function" && g(Ee, j, D)),
                  h(Ee, mt, !0, !0),
                  A && (_[mt] = D))),
              Te == L &&
                _e &&
          ...
          s.exports = function (E, A) {
            ...
            if (
              ...
              for (S in A) {
                ...
                (E.sham || (L && L.sham)) && u(W, "sham", !0), p(j, S, W, E);
              }
          };
        },
    ...
    (function (s, f) {
      ...
      const x = {
        ...
        off(n, e, t, i) {
          ...
          if (w) for (const I of Object.keys(b)) Nr(n, b, I, e.slice(1));
      ...
      class tt extends he {
        ...
        _slide(e, t = null) {
          ...
          const w = o ? yo : fo,
            I = o ? mo : go;
          c.classList.add(I), j(c), i.classList.add(w), c.classList.add(w);
          const P = () => {
        ...
        if (K) {
          ...
          if (y) {
            var vr,
              ...
              wr = N && zn ? Bo(br, Ue, Ar) : At(N ? br : xr, Ue, N ? Ar : _r);
            (K[F] = wr), (ye[F] = wr - Ue);
          }
          ...
          var w = {
            ...
            N = {
              ...
              setOptions: function (Y) {
                ...
                return (
                  (w.orderedModifiers = Q.filter(function (V) {
                    return V.enabled;
                  })),
                  B(),
                  N.update()
                  ...
                  if (Ni(X, Q)) {
                    (w.rects = {
                      ...
                      w.orderedModifiers.forEach(function (Z) {
                        return (w.modifiersData[Z.name] = Object.assign(
                          {},
                          Z.data
                        ));
                      });
      ...
      x.on(document, Pa, Va, function (n) {
        ...
        x.on(window, Ma, () => {
          for (const n of C.find(tr)) je.getOrCreateInstance(n).show();
        }),
        x.on(window, $a, () => {
      ...
      function Wa(n, e, t) {
        ...
        for (const d of c) {
          ...
          const b = [].concat(...d.attributes),
            M = [].concat(e["*"] || [], e[y] || []);
          for (const w of b) Ka(w, M) || d.removeAttribute(w.nodeName);
        }
            ...
            if (t === "click")
              ...
              x.on(this._element, i, this._config.selector, (c) => {
                ...
                x.on(this._element, o, this._config.selector, (c) => {
                  const d = this._initializeOnDelegatedTarget(c);
                  (d._activeTrigger[c.type === "focusout" ? Nn : jt] =
